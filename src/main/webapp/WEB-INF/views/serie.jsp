...
<body style="font-family: verdana;">
	<div id="header" style="background-color: orange; color: white; padding: 20px; text-align: center;">
		<h1 style="margin-bottom: 0;">${serie.name}</h1>
	</div>
	...
	<div id="content" style="height: 450px; text-align: center;">
		...
		<p style="width: 500px; margin: 0 auto">
			<b>Description: </b>${serie.type.description}</p>
		<p>
			<b>Score: </b>
			<fmt:formatNumber type="number" value="${serie.score}" maxFractionDigits="2" />
		</p>
		<div id="comment"
			style="border-radius: 10px; border: orange solid 2px; width: 280px; margin: 0 auto">
			<form method="POST" action="serie/comment">
				<p>
					<label for="fname">username:</label>
					<input name="username" type="text" placeholder="Your name.."
						style="border: 1px solid #ccc; border-radius: 4px;" required>
				<p>
					<textarea name="content" rows="5" cols="28" style="border: 1px solid #ccc; border-radius: 4px;"
